  ...
  return (
    <>
      <header className="header-main">
        <div className="portfolio-logo">UT</div>
        ...
        {sidebarToggle ? (
          <span id="hamburger-icon" onClick={handleSidebarToggle}>
            <img src={Hamburger} alt="Hamburger Icon" />
          </span>
        ) : (
          <span id="close-icon" onClick={handleSidebarToggle}>
        ...
        <aside
          className={
            sidebarToggle
              ? "sidebar-main sidebar-main-hide"
              : "sidebar-main sidebar-main-show"
          }
        >
